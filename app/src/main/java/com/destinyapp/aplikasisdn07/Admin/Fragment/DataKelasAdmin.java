...
import com.destinyapp.aplikasisdn07.GlobalAdapter.AdapterAllKelas;
...
public class DataKelasAdmin extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        DataKelas = (RecyclerView)view.findViewById(R.id.recyclerDataKelasAdmin);
        mManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        DataKelas.setLayoutManager(mManager);
        getDataKelas();
    }
    private void getDataKelas(){
        ...
        GetAllDataGuru.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                mAdapter = new AdapterAllKelas(getActivity(),mItems);
                DataKelas.setAdapter(mAdapter);
