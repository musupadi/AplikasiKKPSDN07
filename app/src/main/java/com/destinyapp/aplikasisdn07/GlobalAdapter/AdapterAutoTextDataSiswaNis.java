...
public class AdapterAutoTextDataSiswaNis extends ArrayAdapter<DataModel> {
    private List<DataModel> dmListFull;

    public AdapterAutoTextDataSiswaNis(@NonNull Context context, @NonNull List<DataModel> List) {
