...
public class AdapterAutoTextDataGuruNIP extends ArrayAdapter<DataModel> {
    private List<DataModel> dmListFull;

    public AdapterAutoTextDataGuruNIP(@NonNull Context context, @NonNull List<DataModel> countryList) {
