...
public class AdapterAutoTextDataSiswaNama extends ArrayAdapter<DataModel> {
    private List<DataModel> dmListFull;

    public AdapterAutoTextDataSiswaNama(@NonNull Context context, @NonNull List<DataModel> List) {
